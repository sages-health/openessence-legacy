...
/**
 * A GraphSource class that allows for initialization from a group of time series and a set of parameters.
 */
public interface GraphSourceBean extends GraphSource {
