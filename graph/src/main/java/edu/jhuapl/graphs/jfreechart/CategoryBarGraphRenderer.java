...
public class CategoryBarGraphRenderer extends BarRenderer {

    private static final long serialVersionUID = -9002053601770053344L;
    private CategoryItemProperty itemProperty;

    public CategoryBarGraphRenderer(List<? extends DataSeriesInterface> data) {
    ...
    public void setMaximumBarWidth(double percent) {
        super.setMaximumBarWidth(percent);
    }
