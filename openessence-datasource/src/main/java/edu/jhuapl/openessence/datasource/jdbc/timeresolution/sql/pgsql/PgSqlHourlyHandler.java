...
public class PgSqlHourlyHandler extends PgSqlTimeHandler implements ResolutionHandler {


    @Override
    public Enum getCategory() {
        return ResolutionUnitEnum.HOURLY;
    }
    ...
    public Object buildKernel(Object[] resolutionValues)
        ...
        int dayOfYear = intValue(resolutionValues[1], 1);
        int hour = intValue(resolutionValues[2], 2);
    ...
    public List<String> getResolutionColumns(String dimCol, String timezone)
        ...
        List<String> groupCols = new ArrayList<String>(3);
        // YEAR
        //groupCols.add("YEAR(" + dimCol + ")");
        groupCols.add("date_part('year', " + dimCol + tzString + ")");

        // DAY OF YEAR
        //groupCols.add("DAYOFYEAR(" + dimCol + ")");
        groupCols.add("date_part('doy', " + dimCol + tzString + ")");

        // HOUR
        //groupCols.add("HOUR(" + dimCol + ")");
        groupCols.add("date_part('hour', " + dimCol + tzString + ")");
