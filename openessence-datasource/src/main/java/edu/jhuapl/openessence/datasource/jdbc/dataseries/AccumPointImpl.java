...
public class AccumPointImpl implements AccumPoint {

    private final Map<String, Number> values;
    private final Record groupingCombination;

    public AccumPointImpl(Map<String, Number> values, Record groupingCombination) {
        this.values = values;
