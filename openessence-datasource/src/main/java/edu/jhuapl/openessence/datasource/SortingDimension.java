...
public interface SortingDimension extends Dimension {

    /**
     * Produces a sorting filter given a relation and a sorting argument.
     *
     * @param relation The relation operator
     * @return A filter of type OrderByFilter
