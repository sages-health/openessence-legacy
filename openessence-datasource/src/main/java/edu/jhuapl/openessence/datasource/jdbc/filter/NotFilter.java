...
public class NotFilter implements SqlGeneratingFilter {

    private SqlGeneratingFilter subFilter;

    public NotFilter(SqlGeneratingFilter subFilter) {
    ...
    public String getSqlSnippet(JdbcOeDataSource ds) {
        ...
        sb.append("NOT ");
        sb.append("(");
        sb.append(subFilter.getSqlSnippet(ds));
        sb.append(")");
        return sb.toString();
    }

    public List<Object> getArguments(JdbcOeDataSource ds) {
        return subFilter.getArguments(ds);
    }
