...
(function() {
  ...
  */
  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite) {
    var aggregator, axisValues, c, colList, defaults, existingOpts, k, opts, pivotTable, refresh, renderer, rendererControl, tblCols, tr1, tr2, uiTable, x, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
      _this = this;
    if (overwrite == null) {
      overwrite = false;
    }
    ...
    for (_j = 0, _len1 = tblCols.length; _j < _len1; _j++) {
      ...
      if (__indexOf.call(opts.hiddenAttributes, c) < 0) {
        (function(c) {
          var btns, colLabel, filterItem, numKeys, v, valueList, _k, _len2, _ref2;
    ...
    refresh = function() {
      ...
      subopts.filter = function(record) {
        var v, _len5, _n, _ref6;
        for (_n = 0, _len5 = exclusions.length; _n < _len5; _n++) {
          _ref6 = exclusions[_n], k = _ref6[0], v = _ref6[1];
          if (record[k] === v) {
            return false;
          }
        }
