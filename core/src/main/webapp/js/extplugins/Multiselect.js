...
Ext.ux.Multiselect = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		if(!this.legend) {
		    var rHeader = fs.el.down('.'+fs.headerCls);
		    if (rHeader) rHeader.remove();
		}
	...
	//initValue:Ext.emptyFn, // fixes bug where multiselect cannot have pre-selected values
	...
	getRawValue: function(valueField) {
        return this.getValue(valueField) || [];
    },
