...
public class SupportedLocale {
    ...
    public static SupportedLocale fromLocale(Locale locale, MessageSource messageSource) {
        ...
        // display language in target locale, i.e. "español" instead of "Spanish"
        ...
        String lang =
                messageSource.getMessage("language." + locale.getLanguage(), null, defaultDisplayLanguage, locale);
